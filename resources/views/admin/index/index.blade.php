	...
	<div class="menu_dropdown bk_2">
		...
		<dl id="menu-admin">
			...
			<dd>
				...
				<li><a data-href="{{route('authIndex')}}" data-title="权限管理" href="javascript:void(0)">权限管理</a></li>
				<li><a data-href="{{route('managerIndex')}}" data-title="管理员列表" href="javascript:void(0)">管理员列表</a></li>
			</ul>
		</dd>
	</dl>
		<dl id="menu-tongji">
